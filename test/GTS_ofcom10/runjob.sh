...
#mpirun snappyHexMesh -parallel -decomposeParDict system/decomposeParDict.40 -dict system/snappyHexMeshDict > logpart1.snappyHexMesh
#mpirun snappyHexMesh -parallel -decomposeParDict system/decomposeParDict.40 -dict system/snappyHexMeshLayersDict > logpart2.snappyHexMesh
